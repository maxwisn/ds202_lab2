...
=======
charsByRating <- aggregate(choco$Rating, by=list(characteristics=choco$Characteristics2), FUN=mean)
charsByRating[order(charsByRating$x),]
>>>>>>> 170afbd6b503533b01ba3b396d433af22603360b
```
